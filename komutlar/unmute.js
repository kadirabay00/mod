...
const mutelog = message.guild.channels.cache.find(c => c.id === '838428881488707654')//Mute log
const muterol = message.guild.roles.cache.find(r => r.id === '838428844116934706')//Muteli rolü
